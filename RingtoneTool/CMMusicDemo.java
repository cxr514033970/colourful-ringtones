...
import com.cmsc.cmmusic.common.CMMusicActivity;
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				new AlertDialog.Builder(CMMusicDemo.this).setTitle("结果")
						.setMessage((msg.obj).toString()).setPositiveButton("确认", null).show();
				break;
			}
			hideProgressBar();
			if (null != dialog) {
					...
					public void operationResult(Result result) {
						if (null != result) {
							new AlertDialog.Builder(CMMusicDemo.this).setTitle("login")
									.setMessage(result.toString()).setPositiveButton("确认", null)
									.show();
						}
									...
									new Thread() {
										...
										public void run() {
											...
											t = MusicQueryInterface.getMusicsByKey(
													CMMusicDemo.this, URLEncoder.encode("有点甜"), 1,
													5);
											mUIHandler.obtainMessage(0, t).sendToTarget();
										}
									}.start();
		...
		vRingSms.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				VibrateRingManagerInterface.queryVibrateRingDownloadUrlBySms(CMMusicDemo.this,
						"600902000009331935", null, "有点甜", "BY2");
			}
		});
		// 开通会员
